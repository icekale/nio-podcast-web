...
const PLAYER_STORAGE_KEY = 'nio_player_state_v2';
...
function enqueueEpisodes(state, episodes) {
...
function selectEpisode(state, episode, queue = state.queue) {
...
function insertNext(state, episode) {
...
function removeFromQueue(state, episodeId) {
...
function recordHistory(history, episode) {
...
function canResume(positionSeconds, durationSeconds) {
...
function restorePlayerState(raw) {
  try {
