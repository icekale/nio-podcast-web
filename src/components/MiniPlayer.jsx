...
export function MiniPlayer({ player, isPlaying, audioError, onToggle, onRetry, onOpenQueue, queueButtonRef, onSeek, playbackRate = 1, onCycleRate, isClosing = false, onExited }) {
